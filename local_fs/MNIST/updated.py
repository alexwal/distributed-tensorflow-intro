...
if os.path.isdir(FLAGS.log_dir) and FLAGS.task_index == 0: shutil.rmtree(FLAGS.log_dir) # erase previous logs (careful, all threads will run this. Need to only run once...)
